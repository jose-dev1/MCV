    ...
    return isVisible ? (
        ...
        >
            ...
            <div className="flex">
                <button
                    type="button"
                    className={`text-red-600 bg-${color}-800 hover:bg-${color}-900 focus:ring-4 focus:outline-none focus:ring-${color}-200 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center dark:bg-${color}-600 dark:hover:bg-${color}-700 dark:focus:ring-${color}-800`}
                    onClick={handleClose}
                >
